...
- **Unrestricted control is explicit**: enabling **Allow unrestricted browser control** lets page reads, page actions, and tab list/follow/close operations run without confirmation. Disabling it restores the proportional approval rules immediately; protected-page DOM content remains inaccessible.
