...
- **Unrestricted control is explicit**: enabling **Allow unrestricted browser control** lets page reads, page actions, and tab list/follow/close operations run without confirmation. Disabling it immediately cancels in-flight browser tool calls and restores the proportional approval rules; protected-page DOM content remains inaccessible.
